...
// GetSystemInstructions retrieves the "system_instructions" option from the Options.
// Returns the value as a string, or an empty string if the option does not exist.
func (o *Options) GetSystemInstructions() string {
	if o.Has(OptionSystemInstructions) {
...
// SystemInstructions retrieves the "system_instructions" option from the Options.
// Returns the value as a string, or an empty string if the option does not exist.
func (o *Options) SystemInstructions() string {
	if o.Has(OptionSystemInstructions) {
		return o.GetString(OptionSystemInstructions)
	}
	return ""
